...
public class NoteEditor extends Activity {
    ...
    private int mItemBackgroud_Color;
    // 被编辑的便签的ID
    private int _id;
    ...
    private static final String[] PROJECTION =
            new String[]{
                    ...
                    NotePad.Notes.COLUMN_NAME_BACKGROUND, //4背景色
...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 被编辑的便签的ID
        _id = intent.getIntExtra(NotePad.Notes._ID, -1);
        System.out.print(_id);

        //Toast.makeText(this, intent.getIntExtra("alarm", -1), Toast.LENGTH_SHORT).show();
        if (intent.getIntExtra("alarmtag", -1) == 101) {
        ...
        mItemBackgroud_Color = mCursor.getInt(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_ITEM_BACKGROUND));
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            KeyguardManager.KeyguardLock kl = km.newKeyguardLock(NotesList.TAG);
            kl.reenableKeyguard();
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            if (isFinishing() && (length == 0)) {
                ...
                updateNote(text, null,mCursor.getString(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_ALARM_DATE)));
            } else if (mState == STATE_INSERT) {
                updateNote(text, text, null);
                mState = STATE_EDIT;
            }
        }
    }
...
//BEGIN_INCLUDE(paste)
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            String re_time= mCursor.getString(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_ALARM_DATE));
            // Updates the current note with the retrieved title and text.
            updateNote(text, title,re_time);
        }
    }
//END_INCLUDE(paste)
     ...
     */
    private final void updateNote(String text, String title, String re_time) {
        ...
        values.put(NotePad.Notes.COLUMN_NAME_ALARM_DATE, re_time);
        values.put(NotePad.Notes.COLUMN_NAME_ITEM_BACKGROUND, mItemBackgroud_Color);
        values.put(NotePad.Notes.COLUMN_NAME_BACKGROUND, mBackgroud_Color);
...
//                };
//
//                DatePickerDialog dpd = new DatePickerDialog(NoteEditor.this, date,
//                        mYear, mMonth,mDay);
//
//                dpd.show();
            }
...
//                            //提示当前设置好的时间
//                            Toast.makeText(getApplicationContext(), "Set alarm time:"+alarmtime,
...
//        test
//        long a=alarmCalendar.getTimeInMillis();
