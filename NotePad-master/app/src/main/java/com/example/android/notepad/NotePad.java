...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
         ...
         * <P>Type: INTEGER </P>
         */
        public static final String COLUMN_NAME_ITEM_BACKGROUND = "item_background";

        /**
         * Column name for the modification timestamp
         * <P>Type: INTEGER (long from System.curentTimeMillis())</P>
         */
        public static final String COLUMN_NAME_ALARM_DATE = "alarm";

        /**
         * background color setting
         * <P>Type: INTEGER </P>
         */
        public static final int BG_DEFAULT_COLOR = R.drawable.bg_gray;
        public static final int BG_DEFAULT_ITEM_COLOR = R.drawable.item_gray;
    }
}
