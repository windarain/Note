...
// 根据数据库中的值设定背景颜色
        ...
        mText.setTextColor(color);
```
![image](https://raw.githubusercontent.com/windarain/picture/master/notepad/bg.png)  
...
```
![image](https://raw.githubusercontent.com/windarain/picture/master/notepad/alarm.png)  